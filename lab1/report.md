...
Очікувано, при низькому BIRTH-RATE популяція швидко зменшується і вимирає, тоді як при значеннях близьких до 0.1 популяція зберігається стабільною деякий час, а високий BIRTH-RATE призводить до швидкого зростання чисельності.
